...
tags: ["docker", "container", "jenkins", "dockerfile", "docker compose"]
---
...
1. Built-In-Node excutor 설정
    - Jenkins Agent를 도커에서 동적으로 실행할거라 `built-in-node`의 `Number of executors`값을 0으로 설정
        ...
        ![JenkinsAgentDocker01.png](JenkinsAgentDocker01.png)
...
2. Agent Node 추가
    ...
    - Node 설정
        ...
        ![JenkinsAgentDocker02.png](JenkinsAgentDocker02.png)
        
3. Agent 설치 스크립트 확인
    - 이후에 컨테이너 기동에 필요한 secret 값이 포함되어 있으니 확인 필수
    
    ![JenkinsAgentDocker03.png](JenkinsAgentDocker03.png)
...
8. Node 연결 확인
    ...
    ![JenkinsAgentDocker04.png](JenkinsAgentDocker04.png)
    
9. 파이프라인 테스트
    - hello world 테스트 성공!
    
    ![JenkinsAgentDocker05.png](JenkinsAgentDocker05.png)
