...
tags: ["kubernetes", "jenkins", "cicd", "jenkins pipeline", "jenkins agent"]
---
...
2. Built-In-Node excutor 설정
    ...
    ![JenkinsK8SPipelineAgent1.png](JenkinsK8SPipelineAgent1.png)
    
3. K8S Configure
    - Manage Jenkins > Clouds > New Cloud / Configure
    - K8S URL로 Test Connection 확인
    
    ![JenkinsK8SPipelineAgent2.png](JenkinsK8SPipelineAgent2.png)
...
- 파이프라인 에이전트가 K8S에서 Pod로 관리될 때의 Pod 설정을 정의
    ...
    ![JenkinsK8SPipelineAgent3.png](JenkinsK8SPipelineAgent3.png)
