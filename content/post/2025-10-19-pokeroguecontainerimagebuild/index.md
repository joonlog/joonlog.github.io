...
date: 2025-10-19T09:00:00+09:00
categories: ["Container", "Pokerogue"]
tags: ["pokerogue", "rogueserver", "docker", "container", "dockerfile", "oauth"]
---
...
- Pokerogue 이미지 빌드
    ...
    - Pokerogue는 Vite 기반 React 프론트엔드와 Go 기반 백엔드 그리고 Mariadb로 구성
        ...
        ![PokerogueContainerImageBuild01.png](PokerogueContainerImageBuild01.png)
